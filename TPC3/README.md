...
Estrutura dataset_reparacoes.json: Base de dados em formato JSON com o histórico de intervenções.
...
Instalar Dependências -> npm install axios json-server
Iniciar o Servidor de Dados -> json-server --watch dataset_reparacoes.json
Iniciar o Serviço Aplicacional -> node servidor_aplicacional.js
http://localhost:7777/:
